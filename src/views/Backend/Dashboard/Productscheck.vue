<template>
    <div class="container my-5">
                ...
                <tr v-for="(item) in products" :key="item.id">
                    ...
                    <td>
                        <button class="btn btn-outline-warning mr-2"
                            @click.prevent="openPdcModal(false,item)">編輯</button>
        ...
        <!-- Edit Modal -->
        <div class="modal fade" id="pdcModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
        ...
        <!-- dropModel -->
        <div class="modal fade" id="dropModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
